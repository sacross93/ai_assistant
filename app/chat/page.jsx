...
function ChatContent() {
    ...
    useEffect(() => {
        ...
        console.log(`[chat/page.jsx] URL param changed: ${prevParamIdRef.current} → ${conversationIdFromUrl}`);
    ...
    const handleConversationChange = (newConvId) => {
        ...
        router.replace(`/chat?conversationId=${newConvId}`);
    };
    ...
    const handleNewChat = () => {
        ...
        // Navigate to chat root, removing conversationId param
        router.push('/chat');
